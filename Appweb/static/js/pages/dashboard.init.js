...
if (chart1.el !== null) chart1.render();
...
var options = {
  ...
  orders = new ApexCharts(document.querySelector("#orders-chart"), options);
if (orders.el !== null) orders.render();
options = {
  fill: { colors: ["#5b73e8"] },
  series: [55],
  chart: {
...
if (customerchart.el !== null) customerchart.render();
...
var options2 = {
  ...
  growthchart = new ApexCharts(document.querySelector("#growth-chart"), options2);
  if(growthchart.el !== null) growthchart.render();
...
if(saleschart.el !== null) saleschart.render();
